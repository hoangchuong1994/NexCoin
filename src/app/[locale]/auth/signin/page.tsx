    ...
    <div className="flex min-h-screen bg-linear-to-b from-[#020617] via-[#0b1120] to-[#020617]">
        ...
        <div className="max-w-md space-y-8 text-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-[#9fb4d5]">
              Professional trading platform for crypto, stocks, and forex. Join thousands of traders
              worldwide.
            </p>
          </div>
      ...
      <div className="flex flex-1 items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md">
          <div className="rounded-2xl border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.04)] p-8 shadow-2xl backdrop-blur-xl">
            <LoginForm />
          </div>
        </div>
      </div>
